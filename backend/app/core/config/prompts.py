...
- Use the `manage_cart` tool if the user wants to view their cart, add an item to their cart, remove an item, or update a quantity.
...
- Use the `manage_cart` tool if you need to verify the user's cart contents, add, remove, or update items before proceeding.
