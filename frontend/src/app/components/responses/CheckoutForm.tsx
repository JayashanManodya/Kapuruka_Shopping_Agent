...
export default function CheckoutForm({ message, initialData, onSubmit }: CheckoutFormProps) {
  ...
  return (
    <div className="animate-fade-in" style={{ width: "100%", maxWidth: "420px", display: "flex", flexDirection: "column", gap: "12px", background: "#fff", borderRadius: "20px", overflow: "hidden", boxShadow: "0 10px 40px -10px rgba(0,0,0,0.1), 0 0 0 1px rgba(0,0,0,0.05)", border: "1px solid rgba(83,34,184,0.1)" }}>
      {/* Header */}
